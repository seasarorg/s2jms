...
/**
 * JMSメッセージのプロパティの{@link Map}をリスナコンポーネントにバインドするクラスです。
 * 
 * @author koichik
 */
public class JMSPropertiesBinder extends AbstractBinder {
     ...
     */
    public JMSPropertiesBinder(final String name, final BindingType bindingType,
     ...
     */
    public JMSPropertiesBinder(final String name, final BindingType bindingType, final Field field) {
    ...
    protected boolean doBind(final Object target, final Message message, final Object payload) {
        final Map<String, Object> properties = MessageHandlerUtil.getProperties(message);
        bindingSupport.bind(target, properties);
        return true;
    }
