 ...
 */
package org.seasar.jms.connector.ra;
...
public class JMSResourceAdapter implements ResourceAdapter {
    ...
    public void start(final BootstrapContext bc) throws ResourceAdapterInternalException {
        this.bc = bc;
    }
    ...
    public void endpointDeactivation(final MessageEndpointFactory endpointFactory,
            final ActivationSpec spec) {
    }

    public XAResource[] getXAResources(final ActivationSpec[] spec) throws ResourceException {
        return null;
    }
