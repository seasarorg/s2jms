 ...
 * @author koichik
 */
public class TopicManagedConnectionFactoryImpl extends AbstractManagedConnectionFactory {
    ...
    protected ManagedConnection createManagedConnection(final ConnectionRequestInfoImpl info)
        ...
        final TopicConnectionFactory cf = (TopicConnectionFactory) getConnectionFactory();
        final TopicConnection con = (info == null) ? cf.createTopicConnection() : cf
                .createTopicConnection(info.getUser(), info.getPassword());
