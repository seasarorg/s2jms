 ...
 * @author koichik
 */
public class XAQueueManagedConnectionFactoryImpl extends AbstractManagedConnectionFactory {
    ...
    protected ManagedConnection createManagedConnection(final ConnectionRequestInfoImpl info)
        ...
        final XAQueueConnectionFactory cf = (XAQueueConnectionFactory) getConnectionFactory();
        final XAQueueConnection con = (info == null) ? cf.createXAQueueConnection() : cf
                .createXAQueueConnection(info.getUser(), info.getPassword());
